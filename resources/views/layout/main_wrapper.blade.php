...
<head>
  ...
  <title>Clothex The Men Hub</title>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="{{ route('account.dashboard') }} " class="text-nowrap logo-img">
            <img src="{{ asset('assets/images/logos/clothexlogo.jfif') }}"  width="80" alt="" style="margin-top:10px;width: 100px;height: 100;border-radius: 50%;object-fit: cover; overflow: hidden;" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('customer.bill') }}" aria-expanded="false"><span><i class="ti ti-article"></i></span>
                <span class="hide-menu">Create Bill</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('account.logout') }}" aria-expanded="false"><span><i class="ti ti-article"></i></span>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="{{ route('account.logout') }}" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
                  </div>
                </div>
              </li>
            </ul>
