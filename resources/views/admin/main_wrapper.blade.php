      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">Admin Access</span>
            </li>

            @if (Auth::guard('admin')->check())
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{ route('account.productlist') }}" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.logout') }}" aria-expanded="false"><span><i class="ti ti-article"></i></span>
